		...
		>
			...
			<div className="space-y-6 text-sm text-zinc-300 leading-relaxed">
				<section>
					...
					<p>
						butterchurn-mcp hosts a MilkDrop-style WebGL visualizer using the
						butterchurn library. It runs 500+ presets with a synthetic beat
						generator synced to BPM. Companion to mixx-dj-mcp for DJ set
						visuals.
					</p>
				</section>
				...
				<section>
					...
					<ul className="list-disc list-inside space-y-1 text-zinc-400">
						<li>
							Open Presets in the sidebar for search, author filter, grid,
							favorites
						</li>
						<li>
							Click a card to preview live in the hero strip; Demo button
