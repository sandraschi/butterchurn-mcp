		...
		>
			<div className="mb-6">
				...
				<p className="text-sm text-zinc-500 mt-0.5">
					Agent skills bundled with this server
				</p>
			</div>
			...
			{skills.length === 0 && !isLoading && (
				<div className="flex flex-col items-center justify-center py-16 text-zinc-500 border border-dashed border-zinc-800 rounded-xl">
					...
					<p className="text-sm mb-4">
						No skills registered by this server yet
					</p>
					<div className="max-w-md text-xs text-zinc-600 space-y-2">
						<p>
							This server provides MilkDrop visualization tools over MCP. The
							following tools are available:
						</p>
						<ul className="list-disc list-inside space-y-1">
							<li>
								<span className="text-zinc-400 font-mono">get_bpm</span> — Read
								current BPM
							</li>
							<li>
								<span className="text-zinc-400 font-mono">set_bpm</span> — Set
								BPM for sync
							</li>
							<li>
								<span className="text-zinc-400 font-mono">list_presets</span> —
								Browse MilkDrop presets
							</li>
							<li>
								<span className="text-zinc-400 font-mono">load_preset</span> —
								Activate a preset
							</li>
							<li>
			...
			<div className="space-y-4">
				{skills.map((s) => (
					...
					>
						...
						<pre className="text-xs text-zinc-400 whitespace-pre-wrap font-sans">
