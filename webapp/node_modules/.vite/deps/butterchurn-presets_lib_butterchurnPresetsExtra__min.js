...
var require_butterchurnPresetsExtra_min = __commonJS({
  "node_modules/butterchurn-presets/lib/butterchurnPresetsExtra.min.js"(exports, module) {
    !(function(a, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("butterchurnPresetsExtra", [], t) : "object" == typeof exports ? exports.butterchurnPresetsExtra = t() : a.butterchurnPresetsExtra = t();
      ...
      return (function(a) {
        ...
        function e(r) {
          ...
          return a[r].call(n.exports, n, n.exports, e), n.l = true, n.exports;
        }
        return e.m = a, e.c = t, e.d = function(a2, t2, r) {
          e.o(a2, t2) || Object.defineProperty(a2, t2, { configurable: false, enumerable: true, get: r });
        }, e.n = function(a2) {
        ...
        var e = a.exports = { version: "2.5.3" };
        "number" == typeof __e && (__e = e);
      }, function(a, t, e) {
        var r = e(15), n = e(16), s = e(18), _ = Object.defineProperty;
        t.f = e(0) ? Object.defineProperty : function(a2, t2, e2) {
          if (r(a2), t2 = s(t2, true), r(e2), n) try {
            return _(a2, t2, e2);
          } catch (a3) {
          }
          if ("get" in e2 || "set" in e2) throw TypeError("Accessors not supported!");
          return "value" in e2 && (a2[t2] = e2.value), a2;
        };
      }, function(a, t) {
        a.exports = function(a2) {
          try {
        ...
        "use strict";
        t.__esModule = true, t.default = function(a2, t2) {
          if (!(a2 instanceof t2)) throw new TypeError("Cannot call a class as a function");
        };
      }, function(a, t, e) {
        "use strict";
        t.__esModule = true;
        var r, n = e(8), s = (r = n) && r.__esModule ? r : { default: r };
        t.default = /* @__PURE__ */ (function() {
          function a2(a3, t2) {
            for (var e2 = 0; e2 < t2.length; e2++) {
              var r2 = t2[e2];
              r2.enumerable = r2.enumerable || false, r2.configurable = true, "value" in r2 && (r2.writable = true), (0, s.default)(a3, r2.key, r2);
            }
          }
          return function(t2, e2, r2) {
            return e2 && a2(t2.prototype, e2), r2 && a2(t2, r2), t2;
          };
        })();
      }, function(a, t, e) {
        a.exports = { default: e(9), __esModule: true };
      }, function(a, t, e) {
        e(10);
        var r = e(3).Object;
        a.exports = function(a2, t2, e2) {
          return r.defineProperty(a2, t2, e2);
        };
      }, function(a, t, e) {
        var r = e(11);
        r(r.S + r.F * !e(0), "Object", { defineProperty: e(4).f });
      }, function(a, t, e) {
        var r = e(2), n = e(3), s = e(12), _ = e(14), v = function(a2, t2, e2) {
          var m, i, l, b = a2 & v.F, p = a2 & v.G, x = a2 & v.S, o = a2 & v.P, d = a2 & v.B, c = a2 & v.W, u = p ? n : n[t2] || (n[t2] = {}), y = u.prototype, h = p ? r : x ? r[t2] : (r[t2] || {}).prototype;
          for (m in p && (e2 = t2), e2) (i = !b && h && void 0 !== h[m]) && m in u || (l = i ? h[m] : e2[m], u[m] = p && "function" != typeof h[m] ? e2[m] : d && i ? s(l, r) : c && h[m] == l ? (function(a3) {
            var t3 = function(t4, e3, r2) {
              if (this instanceof a3) {
                ...
                return new a3(t4, e3, r2);
              }
              return a3.apply(this, arguments);
            };
            return t3.prototype = a3.prototype, t3;
          })(l) : o && "function" == typeof l ? s(Function.call, l) : l, o && ((u.virtual || (u.virtual = {}))[m] = l, a2 & v.R && y && !y[m] && _(y, m, l)));
        };
        v.F = 1, v.G = 2, v.S = 4, v.P = 8, v.B = 16, v.W = 32, v.U = 64, v.R = 128, a.exports = v;
      }, function(a, t, e) {
        var r = e(13);
        a.exports = function(a2, t2, e2) {
          if (r(a2), void 0 === t2) return a2;
          switch (e2) {
            case 1:
              return function(e3) {
                return a2.call(t2, e3);
              };
            case 2:
              return function(e3, r2) {
                return a2.call(t2, e3, r2);
              };
            case 3:
              return function(e3, r2, n) {
                return a2.call(t2, e3, r2, n);
              };
          }
          return function() {
            return a2.apply(t2, arguments);
          };
        };
      }, function(a, t) {
        a.exports = function(a2) {
        ...
        var r = e(4), n = e(19);
        a.exports = e(0) ? function(a2, t2, e2) {
          return r.f(a2, t2, n(1, e2));
        } : function(a2, t2, e2) {
          return a2[t2] = e2, a2;
        };
      }, function(a, t, e) {
        var r = e(1);
        a.exports = function(a2) {
          if (!r(a2)) throw TypeError(a2 + " is not an object!");
          return a2;
        };
      }, function(a, t, e) {
        a.exports = !e(0) && !e(5)(function() {
          return 7 != Object.defineProperty(e(17)("div"), "a", { get: function() {
            return 7;
          } }).a;
        });
      }, function(a, t, e) {
        var r = e(1), n = e(2).document, s = r(n) && r(n.createElement);
        a.exports = function(a2) {
          return s ? n.createElement(a2) : {};
        };
      }, function(a, t, e) {
        var r = e(1);
        a.exports = function(a2, t2) {
          if (!r(a2)) return a2;
          var e2, n;
          if (t2 && "function" == typeof (e2 = a2.toString) && !r(n = e2.call(a2))) return n;
          if ("function" == typeof (e2 = a2.valueOf) && !r(n = e2.call(a2))) return n;
          if (!t2 && "function" == typeof (e2 = a2.toString) && !r(n = e2.call(a2))) return n;
          throw TypeError("Can't convert object to primitive value");
        };
      }, function(a, t) {
        a.exports = function(a2, t2) {
          return { enumerable: !(1 & a2), configurable: !(2 & a2), writable: !(4 & a2), value: t2 };
        };
      }, , , , , , , , function(a, t) {
        ...
        a.exports = { baseVals: { rating: 0, gammaadj: 1.9, echo_zoom: 1.169, wave_mode: 7, modwavealphabyvolume: 1, wave_a: 0, wave_scale: 1.015, wave_smoothing: 0.522, modwavealphastart: 0.83, modwavealphaend: 1.31, warpanimspeed: 30.965, warpscale: 2.572, zoom: 1.00901, warp: 54e-5, wave_r: 0.5, wave_g: 0.5, wave_b: 0.5, mv_a: 0 }, shapes: [{ baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }], waves: [{ baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }], init_eqs_str: "a.dx_residual=0;a.dy_residual=0;a.bass_thresh=0;a.rg=0;a.q9=0;", frame_eqs_str: "a.wave_r=.85+.25*Math.sin(.437*a.time+1);a.wave_g=.85+.25*Math.sin(.544*a.time+2);a.wave_b=.85+.25*Math.sin(.751*a.time+3);a.rot+=.01*(.6*Math.sin(.381*a.time)+.4*Math.sin(.579*a.time));a.cx+=.21*(.6*Math.sin(.374*a.time)+.4*Math.sin(.294*a.time));a.cy+=.21*(.6*Math.sin(.393*a.time)+.4*Math.sin(.223*a.time));a.dx+=.003*(.6*Math.sin(.234*a.time)+.4*Math.sin(.277*a.time));a.dy+=.003*(.6*Math.sin(.284*a.time)+.4*Math.sin(.247*a.time));a.decay-=.01*equal(mod(a.frame,6),0);a.dx+=\na.dx_residual;a.dy+=a.dy_residual;a.bass_thresh=2*above(a.bass_att,a.bass_thresh)+(1-above(a.bass_att,a.bass_thresh))*(.96*(a.bass_thresh-1.3)+1.3);a.dx_residual=.016*equal(a.bass_thresh,2.13)*Math.sin(7*a.time)+(1-equal(a.bass_thresh,2.13))*a.dx_residual;a.dy_residual=.012*equal(a.bass_thresh,2.13)*Math.sin(9*a.time)+(1-equal(a.bass_thresh,2.13))*a.dy_residual;a.wave_x-=7*a.dx_residual;a.wave_y-=7*a.dy_residual;a.wave_mystery=.03*a.time;a.rg=Math.max(.77*a.rg,.02+.5*Math.min(2,1.3*Math.max(0,a.mid_att-\n1)));a.q9=a.rg;a.zoom+=.1*a.q9;", pixel_eqs_str: "", pixel_eqs: "", warp: " shader_body { \n  vec3 z_1;\n  vec3 tmpvar_2;\n  vec2 tmpvar_3;\n  tmpvar_3 = (0.1 * texsize.zw);\n  tmpvar_2 = (0.25 * ((\n    (texture (sampler_main, (uv + tmpvar_3)).xyz + texture (sampler_main, (uv + (tmpvar_3 * vec2(-1.0, 1.0)))).xyz)\n   + texture (sampler_main, \n    (uv + (tmpvar_3 * vec2(1.0, -1.0)))\n  ).xyz) + texture (sampler_main, (uv - tmpvar_3)).xyz));\n  float tmpvar_4;\n  tmpvar_4 = ((tmpvar_2.x * tmpvar_2.y) * tmpvar_2.y);\n  z_1.x = (tmpvar_2.x + ((\n    -(tmpvar_4)\n   + \n    (0.035 * (1.0 - tmpvar_2.x))\n  ) * 4.0));\n  z_1.y = (tmpvar_2.y + ((tmpvar_4 - \n    (0.095 * tmpvar_2.y)\n  ) * 4.0));\n  z_1.z = tmpvar_2.z;\n  z_1.x = (z_1.x + (0.4 * (\n    ((texture (sampler_blur2, uv).xyz * scale2) + bias2)\n   - texture (sampler_main, uv).xyz)).x);\n  vec4 tmpvar_5;\n  tmpvar_5.w = 1.0;\n  tmpvar_5.xyz = (z_1 + (0.09 * (\n    (texture (sampler_noise_lq, (((uv * texsize.xy) * texsize_noise_lq.zw) + rand_frame.xy)).xyz * 2.0)\n   - 1.0)));\n  ret = tmpvar_5.xyz;\n }", comp: " shader_body { \n  vec3 ret_1;\n  ret_1 = texture (sampler_main, uv).xyz;\n  ret_1 = ret_1.xzy;\n  vec4 tmpvar_2;\n  tmpvar_2.w = 1.0;\n  tmpvar_2.xyz = ret_1;\n  ret = tmpvar_2.xyz;\n }" };
      }, function(a, t) {
        a.exports = { baseVals: { rating: 0, gammaadj: 1.9, echo_zoom: 1.16936, wave_mode: 7, modwavealphabyvolume: 1, wave_a: 0, wave_scale: 1.015009, wave_smoothing: 0.522, modwavealphastart: 0.83, modwavealphaend: 1.31, warpanimspeed: 30.965099, warpscale: 2.571729, zoom: 1.009006, warp: 536e-6, wave_r: 0.5, wave_g: 0.5, wave_b: 0.5, mv_a: 0 }, shapes: [{ baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }], waves: [{ baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }], init_eqs_str: "a.dx_residual=0;a.dy_residual=0;a.bass_thresh=0;a.rg=0;a.q9=0;", frame_eqs_str: "a.wave_r=.85+.25*Math.sin(.437*a.time+1);a.wave_g=.85+.25*Math.sin(.544*a.time+2);a.wave_b=.85+.25*Math.sin(.751*a.time+3);a.rot+=.01*(.6*Math.sin(.381*a.time)+.4*Math.sin(.579*a.time));a.cx+=.21*(.6*Math.sin(.374*a.time)+.4*Math.sin(.294*a.time));a.cy+=.21*(.6*Math.sin(.393*a.time)+.4*Math.sin(.223*a.time));a.dx+=.003*(.6*Math.sin(.234*a.time)+.4*Math.sin(.277*a.time));a.dy+=.003*(.6*Math.sin(.284*a.time)+.4*Math.sin(.247*a.time));a.decay-=.01*equal(mod(a.frame,6),0);a.dx+=\na.dx_residual;a.dy+=a.dy_residual;a.bass_thresh=2*above(a.bass_att,a.bass_thresh)+(1-above(a.bass_att,a.bass_thresh))*(.96*(a.bass_thresh-1.3)+1.3);a.dx_residual=.016*equal(a.bass_thresh,2.13)*Math.sin(7*a.time)+(1-equal(a.bass_thresh,2.13))*a.dx_residual;a.dy_residual=.012*equal(a.bass_thresh,2.13)*Math.sin(9*a.time)+(1-equal(a.bass_thresh,2.13))*a.dy_residual;a.wave_x-=7*a.dx_residual;a.wave_y-=7*a.dy_residual;a.wave_mystery=.03*a.time;a.rg=Math.max(.77*a.rg,.02+.5*Math.min(2,1.3*Math.max(0,a.mid_att-\n1)));a.q9=a.rg;a.zoom+=.1*a.q9;", pixel_eqs_str: "", pixel_eqs: "", warp: " shader_body { \n  vec3 ret_1;\n  ret_1 = texture (sampler_main, uv).xyz;\n  ret_1 = (ret_1 + ((ret_1 - \n    ((texture (sampler_blur2, uv).xyz * scale2) + bias2)\n  ) * 0.3));\n  ret_1 = (ret_1 * 0.9);\n  ret_1 = (ret_1 + ((\n    ((texture (sampler_noise_lq, ((\n      (uv_orig * texsize.xy)\n     * \n      (texsize_noise_lq.zw * 0.4)\n    ) + rand_frame.xy)).xyz - 0.5) / 256.0)\n   * 122.0) * clamp (\n    (treb_att - 1.0)\n  , 0.0, 1.0)));\n  ret_1 = mix (ret_1, vec3(dot (ret_1, vec3(0.32, 0.49, 0.29))), vec3(0.2, 0.2, 0.2));\n  vec4 tmpvar_2;\n  tmpvar_2.w = 1.0;\n  tmpvar_2.xyz = ret_1;\n  ret = tmpvar_2.xyz;\n }", comp: " shader_body { \n  vec3 ret_1;\n  ret_1 = (texture (sampler_main, uv).xyz + ((\n    (texture (sampler_blur1, uv).xyz * scale1)\n   + bias1) * 0.4));\n  vec3 tmpvar_2;\n  tmpvar_2 = pow (ret_1, vec3(0.5, 0.8, 1.7));\n  ret_1 = tmpvar_2;\n  vec4 tmpvar_3;\n  tmpvar_3.w = 1.0;\n  tmpvar_3.xyz = tmpvar_2;\n  ret = tmpvar_3.xyz;\n }" };
      }, function(a, t) {
...
export default require_butterchurnPresetsExtra_min();
//# sourceMappingURL=butterchurn-presets_lib_butterchurnPresetsExtra__min.js.map
