...
var require_butterchurnPresetsExtra2_min = __commonJS({
  "node_modules/butterchurn-presets/lib/butterchurnPresetsExtra2.min.js"(exports, module) {
    !(function(a, e) {
      "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("butterchurnPresetsExtra2", [], e) : "object" == typeof exports ? exports.butterchurnPresetsExtra2 = e() : a.butterchurnPresetsExtra2 = e();
      ...
      return (function(a) {
        ...
        function t(s) {
          ...
          return a[s].call(r.exports, r, r.exports, t), r.l = true, r.exports;
        }
        return t.m = a, t.c = e, t.d = function(a2, e2, s) {
          t.o(a2, e2) || Object.defineProperty(a2, e2, { configurable: false, enumerable: true, get: s });
        }, t.n = function(a2) {
        ...
        a.exports = function(a2) {
          return "object" == typeof a2 ? null !== a2 : "function" == typeof a2;
        };
      }, function(a, e) {
        ...
        var s = t(15), r = t(16), n = t(18), _ = Object.defineProperty;
        e.f = t(0) ? Object.defineProperty : function(a2, e2, t2) {
          if (s(a2), e2 = n(e2, true), s(t2), r) try {
            return _(a2, e2, t2);
          } catch (a3) {
          }
          if ("get" in t2 || "set" in t2) throw TypeError("Accessors not supported!");
        ...
        e.__esModule = true, e.default = function(a2, e2) {
          if (!(a2 instanceof e2)) throw new TypeError("Cannot call a class as a function");
        };
      }, function(a, e, t) {
        "use strict";
        e.__esModule = true;
        var s, r = t(8), n = (s = r) && s.__esModule ? s : { default: s };
        e.default = /* @__PURE__ */ (function() {
          function a2(a3, e2) {
            for (var t2 = 0; t2 < e2.length; t2++) {
              var s2 = e2[t2];
              s2.enumerable = s2.enumerable || false, s2.configurable = true, "value" in s2 && (s2.writable = true), (0, n.default)(a3, s2.key, s2);
            }
          }
          return function(e2, t2, s2) {
            return t2 && a2(e2.prototype, t2), s2 && a2(e2, s2), e2;
          };
        })();
      }, function(a, e, t) {
        ...
        a.exports = function(a2, e2, t2) {
          return s.defineProperty(a2, e2, t2);
        };
      }, function(a, e, t) {
        var s = t(11);
        s(s.S + s.F * !t(0), "Object", { defineProperty: t(4).f });
      }, function(a, e, t) {
        var s = t(2), r = t(3), n = t(12), _ = t(14), m = function(a2, e2, t2) {
          var v, i, b, p = a2 & m.F, l = a2 & m.G, o = a2 & m.S, x = a2 & m.P, d = a2 & m.B, h = a2 & m.W, c = l ? r : r[e2] || (r[e2] = {}), y = c.prototype, u = l ? s : o ? s[e2] : (s[e2] || {}).prototype;
          for (v in l && (t2 = e2), t2) (i = !p && u && void 0 !== u[v]) && v in c || (b = i ? u[v] : t2[v], c[v] = l && "function" != typeof u[v] ? t2[v] : d && i ? n(b, s) : h && u[v] == b ? (function(a3) {
            var e3 = function(e4, t3, s2) {
              if (this instanceof a3) {
                ...
                return new a3(e4, t3, s2);
              }
              return a3.apply(this, arguments);
            };
            return e3.prototype = a3.prototype, e3;
          })(b) : x && "function" == typeof b ? n(Function.call, b) : b, x && ((c.virtual || (c.virtual = {}))[v] = b, a2 & m.R && y && !y[v] && _(y, v, b)));
        };
        m.F = 1, m.G = 2, m.S = 4, m.P = 8, m.B = 16, m.W = 32, m.U = 64, m.R = 128, a.exports = m;
      }, function(a, e, t) {
        var s = t(13);
        a.exports = function(a2, e2, t2) {
          if (s(a2), void 0 === e2) return a2;
          switch (t2) {
            case 1:
              return function(t3) {
            ...
            case 2:
              return function(t3, s2) {
                return a2.call(e2, t3, s2);
              };
            case 3:
              return function(t3, s2, r) {
                return a2.call(e2, t3, s2, r);
              };
          }
          return function() {
        ...
        a.exports = function(a2) {
          if ("function" != typeof a2) throw TypeError(a2 + " is not a function!");
          return a2;
        };
      }, function(a, e, t) {
        var s = t(4), r = t(19);
        a.exports = t(0) ? function(a2, e2, t2) {
          return s.f(a2, e2, r(1, t2));
        } : function(a2, e2, t2) {
          return a2[e2] = t2, a2;
        };
      }, function(a, e, t) {
        var s = t(1);
        a.exports = function(a2) {
          if (!s(a2)) throw TypeError(a2 + " is not an object!");
          return a2;
        };
      }, function(a, e, t) {
        a.exports = !t(0) && !t(5)(function() {
          return 7 != Object.defineProperty(t(17)("div"), "a", { get: function() {
            return 7;
          } }).a;
        });
      }, function(a, e, t) {
        var s = t(1), r = t(2).document, n = s(r) && s(r.createElement);
        a.exports = function(a2) {
          return n ? r.createElement(a2) : {};
        };
      }, function(a, e, t) {
        var s = t(1);
        a.exports = function(a2, e2) {
          if (!s(a2)) return a2;
          var t2, r;
          if (e2 && "function" == typeof (t2 = a2.toString) && !s(r = t2.call(a2))) return r;
          if ("function" == typeof (t2 = a2.valueOf) && !s(r = t2.call(a2))) return r;
          if (!e2 && "function" == typeof (t2 = a2.toString) && !s(r = t2.call(a2))) return r;
        ...
        a.exports = { baseVals: { rating: 2, gammaadj: 1.35, decay: 1, echo_zoom: 0.999599, echo_alpha: 0.5, echo_orient: 1, wave_mode: 5, wrap: 0, darken: 1, wave_a: 0.690724, wave_scale: 4.778029, wave_smoothing: 0, modwavealphastart: 0.71, modwavealphaend: 1.3, warpscale: 1.331, fshader: 1, zoom: 0.999513, warp: 0.0101, wave_r: 0.65, wave_g: 0.65, wave_b: 0.65, ob_size: 5e-3, ob_a: 0.1, ib_size: 0, mv_a: 0 }, shapes: [{ baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }], waves: [{ baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }, { baseVals: { enabled: 0 } }], init_eqs_str: "a.thresh=0;a.dx_r=0;a.dy_r=0;", frame_eqs_str: "a.wave_r+=.5*Math.sin(1.13*a.time);a.wave_g+=.5*Math.sin(1.23*a.time);a.wave_b+=.5*Math.sin(1.33*a.time);a.wave_x+=.2*Math.sin(.32*a.time);a.wave_y+=.2*Math.cos(.32*a.time);a.ob_r=a.wave_r;a.ob_g=a.wave_g;a.ob_b=a.wave_b;", pixel_eqs_str: "a.thresh=2*above(a.bass_att,a.thresh)+(1-above(a.bass_att,a.thresh))*(.96*(a.thresh-1.3)+1.3);a.dx_r=.015*equal(a.thresh,2)*Math.sin(5*a.time)+(1-equal(a.thresh,2))*a.dx_r;a.dy_r=.015*equal(a.thresh,2)*Math.sin(6*a.time)+(1-equal(a.thresh,2))*a.dy_r;a.zoom+=.0095*(Math.sin(24*a.ang)+.3*Math.sin(Math.sin(2*a.time*Math.sin(a.time)*a.rad))-.5*Math.cos(a.rad))*above(Math.sin(a.time),0);a.zoom+=.0095*(Math.sin(6*a.ang)+.3*Math.sin(Math.sin(2*a.time*Math.sin(a.time)*a.rad))-.1*Math.cos(a.rad))*\nbelow(Math.sin(a.time),0);a.rot+=.08*Math.abs(.746-a.rad)*Math.sin(2.2*(.5-a.rad)+5.7*Math.sin(.1*a.time));a.sx+=.01*(.99-a.rad)*Math.sin(.733*a.time)*below(Math.sin(a.time),0);a.sy+=.01*(.99-a.rad)*Math.cos(.953*a.time)*above(Math.sin(a.time),0);a.zoom-=.015*(1.5-a.rad)*below(a.rad,1.5);", warp: "", comp: "" };
      }, function(a, e) {
...
export default require_butterchurnPresetsExtra2_min();
//# sourceMappingURL=butterchurn-presets_lib_butterchurnPresetsExtra2__min.js.map
