...
// node_modules/butterchurn-presets/lib/butterchurnPresetsMD1.min.js
var require_butterchurnPresetsMD1_min = __commonJS({
  "node_modules/butterchurn-presets/lib/butterchurnPresetsMD1.min.js"(exports, module) {
    !(function(a, e) {
      "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("butterchurnPresetsMD1", [], e) : "object" == typeof exports ? exports.butterchurnPresetsMD1 = e() : a.butterchurnPresetsMD1 = e();
    })("undefined" != typeof self ? self : exports, function() {
      return (function(a) {
        var e = {};
        function s(t) {
          if (e[t]) return e[t].exports;
          var i = e[t] = { i: t, l: false, exports: {} };
          return a[t].call(i.exports, i, i.exports, s), i.l = true, i.exports;
        }
        return s.m = a, s.c = e, s.d = function(a2, e2, t) {
          s.o(a2, e2) || Object.defineProperty(a2, e2, { configurable: false, enumerable: true, get: t });
        }, s.n = function(a2) {
        ...
        var s = a.exports = "undefined" != typeof window && window.Math == Math ? window : "undefined" != typeof self && self.Math == Math ? self : Function("return this")();
        "number" == typeof __g && (__g = s);
      }, function(a, e) {
        var s = a.exports = { version: "2.5.3" };
        "number" == typeof __e && (__e = s);
      }, function(a, e, s) {
        var t = s(15), i = s(16), b = s(18), o = Object.defineProperty;
        e.f = s(0) ? Object.defineProperty : function(a2, e2, s2) {
          if (t(a2), e2 = b(e2, true), t(s2), i) try {
            return o(a2, e2, s2);
          } catch (a3) {
          }
          if ("get" in s2 || "set" in s2) throw TypeError("Accessors not supported!");
          return "value" in s2 && (a2[e2] = s2.value), a2;
        };
      }, function(a, e) {
        a.exports = function(a2) {
          try {
        ...
        "use strict";
        e.__esModule = true;
        var t, i = s(8), b = (t = i) && t.__esModule ? t : { default: t };
        e.default = /* @__PURE__ */ (function() {
          function a2(a3, e2) {
            for (var s2 = 0; s2 < e2.length; s2++) {
              var t2 = e2[s2];
              t2.enumerable = t2.enumerable || false, t2.configurable = true, "value" in t2 && (t2.writable = true), (0, b.default)(a3, t2.key, t2);
            }
          }
          return function(e2, s2, t2) {
            return s2 && a2(e2.prototype, s2), t2 && a2(e2, t2), e2;
          };
        })();
      }, function(a, e, s) {
        a.exports = { default: s(9), __esModule: true };
      }, function(a, e, s) {
        s(10);
        var t = s(3).Object;
        a.exports = function(a2, e2, s2) {
          return t.defineProperty(a2, e2, s2);
        };
      }, function(a, e, s) {
        var t = s(11);
        t(t.S + t.F * !s(0), "Object", { defineProperty: s(4).f });
      }, function(a, e, s) {
        var t = s(2), i = s(3), b = s(12), o = s(14), r = function(a2, e2, s2) {
          var n, _, m, h = a2 & r.F, l = a2 & r.G, d = a2 & r.S, p = a2 & r.P, v = a2 & r.B, q = a2 & r.W, c = l ? i : i[e2] || (i[e2] = {}), M = c.prototype, x = l ? t : d ? t[e2] : (t[e2] || {}).prototype;
          for (n in l && (s2 = e2), s2) (_ = !h && x && void 0 !== x[n]) && n in c || (m = _ ? x[n] : s2[n], c[n] = l && "function" != typeof x[n] ? s2[n] : v && _ ? b(m, t) : q && x[n] == m ? (function(a3) {
            var e3 = function(e4, s3, t2) {
              if (this instanceof a3) {
                ...
                return new a3(e4, s3, t2);
              }
              return a3.apply(this, arguments);
            };
            return e3.prototype = a3.prototype, e3;
          })(m) : p && "function" == typeof m ? b(Function.call, m) : m, p && ((c.virtual || (c.virtual = {}))[n] = m, a2 & r.R && M && !M[n] && o(M, n, m)));
        };
        r.F = 1, r.G = 2, r.S = 4, r.P = 8, r.B = 16, r.W = 32, r.U = 64, r.R = 128, a.exports = r;
      }, function(a, e, s) {
        var t = s(13);
        a.exports = function(a2, e2, s2) {
          if (t(a2), void 0 === e2) return a2;
          switch (s2) {
            case 1:
              return function(s3) {
                return a2.call(e2, s3);
              };
            case 2:
              return function(s3, t2) {
                return a2.call(e2, s3, t2);
              };
            case 3:
              return function(s3, t2, i) {
                return a2.call(e2, s3, t2, i);
              };
          }
          return function() {
        ...
        var t = s(4), i = s(19);
        a.exports = s(0) ? function(a2, e2, s2) {
          return t.f(a2, e2, i(1, s2));
        } : function(a2, e2, s2) {
          return a2[e2] = s2, a2;
        };
      }, function(a, e, s) {
        var t = s(1);
        a.exports = function(a2) {
          if (!t(a2)) throw TypeError(a2 + " is not an object!");
          return a2;
        };
      }, function(a, e, s) {
        a.exports = !s(0) && !s(5)(function() {
          return 7 != Object.defineProperty(s(17)("div"), "a", { get: function() {
            return 7;
          } }).a;
        });
      }, function(a, e, s) {
        var t = s(1), i = s(2).document, b = t(i) && t(i.createElement);
        a.exports = function(a2) {
          return b ? i.createElement(a2) : {};
        };
      }, function(a, e, s) {
        var t = s(1);
        a.exports = function(a2, e2) {
          if (!t(a2)) return a2;
          var s2, i;
          if (e2 && "function" == typeof (s2 = a2.toString) && !t(i = s2.call(a2))) return i;
          if ("function" == typeof (s2 = a2.valueOf) && !t(i = s2.call(a2))) return i;
          if (!e2 && "function" == typeof (s2 = a2.toString) && !t(i = s2.call(a2))) return i;
